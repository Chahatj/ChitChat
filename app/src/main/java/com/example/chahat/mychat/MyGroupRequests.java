...
public class MyGroupRequests {
    ...
    public MyGroupRequests(Context context) {
    ...
    public void storeGroupChatDataInBackground(GroupChat message,
       ...
       // progressDialog.show();
        new StoreMyGroupDataAsyncTask(message, messageCallback).execute();
    }

    public void fetchMyGroupDataAsyncTask(GroupChat message, GroupChatCallback messageCallback) {
        progressDialog.show();
        new fetchMyGroupDataAsyncTask(message,messageCallback).execute();
    }
    ...
    public class StoreMyGroupDataAsyncTask extends AsyncTask<Void, Void, Void> {
        GroupChat message;
        GroupChatCallback messageCallback;

        public StoreMyGroupDataAsyncTask(GroupChat message, GroupChatCallback messageCallback) {
    ...
    public class fetchMyGroupDataAsyncTask extends AsyncTask<Void, Void,List<String>> {
        GroupChat message;
        GroupChatCallback messageCallback;
        List<String> list=new ArrayList<>();


        public fetchMyGroupDataAsyncTask(GroupChat message, GroupChatCallback messageCallback) {
            this.message = message;
            this.messageCallback = messageCallback;
        }
                ...
                for (int i=0;i<n;i++)
                {
                 ...
                 //   long Sender = js.getLong("Sender");
                   // long Rec1 = js.getLong("Recieverone");
                    ...
                    returnedMessage= new GroupChat(message,-1,-1,-1,-1,-1,"");

                    String messageone = returnedMessage.getGroupname();
